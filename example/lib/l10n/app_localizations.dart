...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to: **'Example'**
  String get appTitle;

  /// Label for the 'bricks' screen on the bottom navigation
  ///
  /// In en, this message translates to: **'Bricks'**
  String get bricks;

  /// Label for the 'lamp' screen on the bottom navigation
  ///
  /// In en, this message translates to: **'Lamp'**
  String get lamp;
  ...
  ///
  /// In en, this message translates to: **'ON'**
  String get lampOn;
}
