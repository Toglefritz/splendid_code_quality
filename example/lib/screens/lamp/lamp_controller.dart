...
import 'lamp_route.dart';
import 'lamp_view.dart';

/// Controller for the lamp screen that manages state and business logic.
///
/// Extends `State<LampRoute>` to provide state management capabilities and serves as the bridge between the route and
/// view components. All user interactions and state changes are handled here.
class LampController extends State<LampRoute> {
  ...
  @override
  Widget build(BuildContext context) => LampView(this);
}
